...
const OurPolicy = () => {
  return (
    ...
    sm:text-sm md:text-base text-gray-700 px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]'>  
        <div>
            <img src={assets.shipping} className='w-13 m-auto mb-3' alt="Shipping" />
            <p className='font-semibold'>Free Shipping</p>
            <p className='text-gray-400'>For orders over 100 USD</p>
        </div>
        <div>
            <img src={assets.easyReturn} className='w-13 m-auto mb-3' alt="Return" />
            <p className='font-semibold'>Easy Returns</p>
            <p className='text-gray-400'>Free returns within 7 days after delivery</p>
        </div>
        <div>
            <img src={assets.payment} className='w-13 m-auto mb-3' alt="payment" />
