    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw]'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='w-fukk text-end mt-8'>
            <button onClick={() => navigate('/orders')} className='bg-black text-white px-16 py-3 text-sm focus:scale-105 transition ease-in-out'>PLACE ORDER</button>
